...
export LOG_LEVEL=debug UPLOAD_DRIVER=mediastore REGION_NAME=us-west-2  BUCKET_NAME=dropbears HTTP_PORT=8080
...
aws mediastore-data put-object --endpoint "https://jzw2ldnc6rzikp.data.mediastore.us-west-2.amazonaws.com" --body /tmp/${vid}.html --path ${vid}.html --cache-control "max-age=6, public" --content-type text/html --region us-west-2
aws mediastore-data put-object --endpoint "https://jzw2ldnc6rzikp.data.mediastore.us-west-2.amazonaws.com" --body /tmp/${vid}.js --path ${vid}.js --cache-control "max-age=6, public" --content-type text/javascript --region us-west-2
